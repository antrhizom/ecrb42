...
export default function Certificate() {
  ...
  // Prüfe ob mindestens die Hälfte der Module abgeschlossen ist
  const requiredModules = Math.ceil(progress.total / 2)
  const hasEnoughModules = progress.completed >= requiredModules
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            Sie müssen mindestens {requiredModules} Themen im Bereich "{learningArea.title}" abschließen, um das Zertifikat zu erhalten.
          </p>
          <p className="text-lg font-semibold text-blue-600 mb-6">
            Abgeschlossen: {progress.completed} von {requiredModules} benötigten Modulen
          </p>
          <button
            onClick={() => router.push('/dashboard')}
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-12 py-8 text-white print:bg-gradient-to-r print:from-blue-600 print:to-blue-500">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100">Urheberrecht im Schulkontext</p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between pt-8 border-t border-gray-200">
              ...
              <div className="text-center">
                <div className="w-48 border-t-2 border-gray-300 pt-2">
                  <p className="text-sm text-gray-600">Lernplattform Urheberrecht</p>
                </div>
              </div>
            </div>
          </div>
